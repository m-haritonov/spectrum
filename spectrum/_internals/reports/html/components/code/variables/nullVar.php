...
class nullVar extends \spectrum\_internals\reports\html\components\component {
	/**
	 * @return string
	 */
	static public function getStyles() {
		return static::formatTextForOutput('<style type="text/css">/*<![CDATA[*/
			...
			.app-resultBuffer>.results>.result.expanded .app-code-variables-null .value { overflow: visible; max-width: none; white-space: normal; }
		/*]]>*/</style>', 2);
	}
