...
/**/
	...
	public function getContextModifiers() {
		if (!$this->contextModifiers) {
			$contextModifiersClass = config::getCoreClassReplacement('\spectrum\core\models\ContextModifiers');
	...
	public function getData() {
		if (!$this->data) {
			$dataClass = config::getCoreClassReplacement('\spectrum\core\models\Data');
	...
	public function getErrorHandling() {
		if (!$this->errorHandling) {
			$errorHandlingClass = config::getCoreClassReplacement('\spectrum\core\models\ErrorHandling');
	...
	public function getExecutor() {
		if (!$this->executor) {
			$testClass = config::getCoreClassReplacement('\spectrum\core\models\Executor');
	...
	public function getMatchers() {
		if (!$this->matchers) {
			$matchersClass = config::getCoreClassReplacement('\spectrum\core\models\Matchers');
	...
	public function getMessages() {
		if (!$this->messages) {
			$messagesClass = config::getCoreClassReplacement('\spectrum\core\models\Messages');
	...
	public function getResults() {
		if (!$this->results) {
			$resultsClass = config::getCoreClassReplacement('\spectrum\core\models\Results');
...
/**/
	...
	protected function outputReportBefore() {
		$getReportClassFunction = config::getCoreFunctionReplacement('\spectrum\core\_private\getReportClass');
	...
	protected function registerErrorHandler() {
		...
		$this->errorHandler = function($errorLevel, $errorMessage, $file, $line) use($thisObj) {
			...
			$phpErrorDetailsClass = config::getCoreClassReplacement('\spectrum\core\models\details\PhpError');
	...
	protected function restoreErrorHandler() {
		$removeSubsequentErrorHandlersFunction = config::getCoreFunctionReplacement('\spectrum\core\_private\removeSubsequentErrorHandlers');
