...
class stringVar extends \spectrum\core\plugins\reports\drivers\html\components\component
{
	static public function getStyles()
	{
		return static::formatTextForOutput('<style type="text/css">/*<![CDATA[*/
			...
			.c-resultBuffer>.results>.result.expanded .c-code-variables-string .value { overflow: visible; max-width: none; white-space: pre; }
			.c-resultBuffer>.results>.result.expanded .c-code-variables-string .value .char { display: inline-block; overflow: hidden; position: relative; height: 12px; }

			.c-resultBuffer>.results>.result.expanded .c-code-variables-string .value .char.space { width: 8px; height: 10px; }
			.c-resultBuffer>.results>.result.expanded .c-code-variables-string .value .char.space:before { content: "\\0020"; position: absolute; bottom: 1px; left: 49%; width: 2px; height: 2px; background: #bbb; }

			.c-resultBuffer>.results>.result.expanded .c-code-variables-string .value .char.tab { width: 15px; }
			.c-resultBuffer>.results>.result.expanded .c-code-variables-string .value .char.tab:before { content: "\\21E5"; position: absolute; right: 0; left: 0; text-align: center; color: #aaa; }

			.c-resultBuffer>.results>.result.expanded .c-code-variables-string .value .char.cr { width: 14px; }
			.c-resultBuffer>.results>.result.expanded .c-code-variables-string .value .char.cr:before { content: "\\21A9"; position: absolute; bottom: -1px; right: 0; left: 0; text-align: center; color: #aaa; }

			.c-resultBuffer>.results>.result.expanded .c-code-variables-string .value .char.lf { width: 10px; height: 11px; }
			.c-resultBuffer>.results>.result.expanded .c-code-variables-string .value .char.lf:before { content: "\\2193"; position: absolute; bottom: 3px; right: 0; left: 0; text-align: center; color: #aaa; }
			.c-resultBuffer>.results>.result.expanded .c-code-variables-string .value .char.lf:after { content: "\\0020"; position: absolute; bottom: 2px; right: 2px; left: 2px; border-bottom: 1px solid #bbb; }
		/*]]>*/</style>', 2);
	}
