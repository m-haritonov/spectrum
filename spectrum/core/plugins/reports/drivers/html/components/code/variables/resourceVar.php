...
class resourceVar extends \spectrum\core\plugins\reports\drivers\html\components\component {
	static public function getStyles() {
		return static::formatTextForOutput('<style type="text/css">/*<![CDATA[*/
			...
			.app-resultBuffer>.results>.result.expanded .app-code-variables-resource .value { overflow: visible; max-width: none; white-space: normal; }
		/*]]>*/</style>', 2);
	}
