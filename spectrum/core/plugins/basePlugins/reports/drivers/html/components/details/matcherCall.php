...
namespace spectrum\core\plugins\basePlugins\reports\drivers\html\components\details;
use spectrum\config;
use \spectrum\core\details\MatcherCallInterface;

class matcherCall extends \spectrum\core\plugins\basePlugins\reports\drivers\html\components\component
{
	static public function getStyles()
	{
		return static::formatTextForOutput('<style type="text/css">/*<![CDATA[*/
			...
			.c-resultBuffer>.results>.result.expand .c-details-matcherCall>.source>p .file .prefix:before { display: none; }
			.c-resultBuffer>.results>.result.expand .c-details-matcherCall>.source>p .file .prefix>span { display: inline; }
		/*]]>*/</style>', 2);
	}
