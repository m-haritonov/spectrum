...
class boolVar extends \spectrum\core\plugins\basePlugins\reports\drivers\html\components\component
{
	static public function getStyles()
	{
		return static::formatTextForOutput('<style type="text/css">/*<![CDATA[*/
			...
			.c-resultBuffer>.results>.result.expand .c-code-variables-bool .value { overflow: visible; max-width: none; white-space: normal; }
		/*]]>*/</style>', 2);
	}
