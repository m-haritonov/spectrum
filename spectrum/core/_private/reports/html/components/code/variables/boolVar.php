...
class boolVar extends \spectrum\core\_private\reports\html\components\component {
	/**
	 * @return string
	 */
	static public function getStyles() {
		return static::formatTextForOutput('<style type="text/css">/*<![CDATA[*/
			...
			.app-results>.results>.result.expanded .app-code-variables-bool .value { overflow: visible; max-width: none; white-space: normal; }
		/*]]>*/</style>', 2);
	}
