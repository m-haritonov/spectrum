...
namespace spectrum\core\specs\plugins\basePlugins\reports;

use spectrum\core\config;
use spectrum\core\specs\plugins\basePlugins\reports\drivers\html\Html;
use spectrum\core\specs\plugins\basePlugins\reports\drivers\text\Text;

class Reports extends \spectrum\core\specs\plugins\Plugin
{
	...
	public function setOutputType($type)
	{
		...
		if (!config::getAllowReportsSettingsModify())
