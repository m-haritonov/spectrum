...
namespace spectrum\core\specs\plugins\basePlugins\reports\drivers;

abstract class Driver implements DriverInterface
{
	protected $ownerPlugin;
	
	public function __construct(\spectrum\core\specs\plugins\basePlugins\reports\Reports $ownerPlugin)
	{
