...
abstract class Variable extends \spectrum\core\specs\plugins\basePlugins\reports\drivers\html\widgets\Widget
{
	protected $type;
	...
	public function __construct(\spectrum\core\specs\plugins\basePlugins\reports\Reports $ownerPlugin, $depth = 0)
	{
