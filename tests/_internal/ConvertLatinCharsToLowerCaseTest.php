...
class ConvertLatinCharsToLowerCaseTest extends \spectrum\tests\Test
{
	...
	{
		$this->assertSame('aabbzzzz', \spectrum\_internal\convertLatinCharsToLowerCase('AaBbZZzz'));
	}
	...
	public function testDoesNotConvertNotLatinChars()
	{
		...
		$this->assertSame("\xDB\xF4" . 'aabbzz' . "\xD0\xAB\xD1\x84", \spectrum\_internal\convertLatinCharsToLowerCase("\xDB\xF4" . 'AaBbZz' . "\xD0\xAB\xD1\x84"));
	}
}