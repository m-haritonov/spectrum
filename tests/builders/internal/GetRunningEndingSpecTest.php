...
class GetRunningEndingSpecTest extends \spectrum\tests\Test
{
	public function testCallsAtRunningState_RootSpecHasNoChildren_ReturnsRootSpec()
	{
		...
		$this->registerPluginWithCodeInEvent('
			\spectrum\tests\Test::$temp["returnValue"] = \spectrum\builders\internal\getRunningEndingSpec();
		', 'onEndingSpecExecute');
	...
	{
		$this->assertSame(null, \spectrum\builders\internal\getRunningEndingSpec());
	}
}