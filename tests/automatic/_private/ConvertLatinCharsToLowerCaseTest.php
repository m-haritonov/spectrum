...
class ConvertLatinCharsToLowerCaseTest extends \spectrum\tests\automatic\Test {
	public function testConvertsLatinCharsToLowerCase() {
		$this->assertSame('aabbzzzz', \spectrum\_private\convertLatinCharsToLowerCase('AaBbZZzz'));
	}
	...
	public function testDoesNotConvertNotLatinChars() {
		...
		$this->assertSame("\xDB\xF4" . 'aabbzz' . "\xD0\xAB\xD1\x84", \spectrum\_private\convertLatinCharsToLowerCase("\xDB\xF4" . 'AaBbZz' . "\xD0\xAB\xD1\x84"));
	}
}