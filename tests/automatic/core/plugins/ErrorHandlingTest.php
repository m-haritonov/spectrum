...
class ErrorHandlingTest extends \spectrum\tests\automatic\Test {
	...
	public function testSetCatchPhpErrors_CallOnRun_ThrowsExceptionAndDoesNotChangeValue() {
		...
		$this->assertSame('Call of "\spectrum\core\plugins\ErrorHandling::setCatchPhpErrors" method is forbidden on run', \spectrum\tests\automatic\Test::$temp["exception"]->getMessage());
...
/**/
	...
	public function testGetCatchPhpErrorsThroughRunningAncestors_ReturnsValueFromRunningAncestorOrFromSelf() {
		...
		$this->registerPluginWithCodeInEvent('
			\spectrum\tests\automatic\Test::$temp["returnValues"][] = $this->getOwnerSpec()->errorHandling->getCatchPhpErrorsThroughRunningAncestors();
		', 'onEndingSpecExecute');
		...
		$this->assertSame(array(2, 3, 4, 1), \spectrum\tests\automatic\Test::$temp["returnValues"]);
	}
...
/**/
	...
	public function testSetBreakOnFirstPhpError_CallOnRun_ThrowsExceptionAndDoesNotChangeValue() {
		...
		$this->assertInstanceOf('\spectrum\Exception', \spectrum\tests\automatic\Test::$temp["exception"]);
		$this->assertSame('Call of "\spectrum\core\plugins\ErrorHandling::setBreakOnFirstPhpError" method is forbidden on run', \spectrum\tests\automatic\Test::$temp["exception"]->getMessage());
		$this->assertSame(true, $spec->errorHandling->getBreakOnFirstPhpError());
	}
...
/**/
	...
	public function testGetBreakOnFirstPhpErrorThroughRunningAncestors_ReturnsValueFromRunningAncestorOrFromSelf() {
		...
		$this->registerPluginWithCodeInEvent('
			\spectrum\tests\automatic\Test::$temp["returnValues"][] = $this->getOwnerSpec()->errorHandling->getBreakOnFirstPhpErrorThroughRunningAncestors();
		', 'onEndingSpecExecute');
		...
		$this->assertSame(array(false, false, true), \spectrum\tests\automatic\Test::$temp["returnValues"]);
	}
...
/**/
	...
	public function testSetBreakOnFirstMatcherFail_CallOnRun_ThrowsExceptionAndDoesNotChangeValue() {
		...
		$this->assertInstanceOf('\spectrum\Exception', \spectrum\tests\automatic\Test::$temp["exception"]);
		$this->assertSame('Call of "\spectrum\core\plugins\ErrorHandling::setBreakOnFirstMatcherFail" method is forbidden on run', \spectrum\tests\automatic\Test::$temp["exception"]->getMessage());
		$this->assertSame(true, $spec->errorHandling->getBreakOnFirstMatcherFail());
	}
...
/**/
	...
	public function testGetBreakOnFirstMatcherFailThroughRunningAncestors_ReturnsValueFromRunningAncestorOrFromSelf() {
		...
		$this->registerPluginWithCodeInEvent('
			\spectrum\tests\automatic\Test::$temp["returnValues"][] = $this->getOwnerSpec()->errorHandling->getBreakOnFirstMatcherFailThroughRunningAncestors();
		', 'onEndingSpecExecute');
...
/**/
	...
	public function testErrorHandling_TakesInAccountDefinedOnRunErrorReportingValue() {
		...
		$this->assertSame(array(), \spectrum\tests\automatic\Test::$temp["resultBuffer"]->getResults());
	}
	...
	public function testErrorHandling_ErrorHandlerWasRemovedOnExecute_AddsFalseToResultBufferAndDoesNotRemoveOtherErrorHandlers() {
		...
		), \spectrum\tests\automatic\Test::$temp["resultBuffer"]->getResults());
	...
	public function testErrorHandling_ErrorTypeIsIncludeTriggeredErrorType_CatchesPhpErrorsAndAddsFalseResultToResultBuffer() {
		...
		$this->assertSame(4, count(\spectrum\tests\automatic\Test::$temp["resultBuffers"]));
		...
		$results = \spectrum\tests\automatic\Test::$temp["resultBuffers"][3]->getResults();
		$this->assertSame(2, count($results));
	...
	public function testErrorHandling_BreakOnFirstPhpErrorIsEnabled_BreaksExecutionOnFirstPhpError() {
		...
		$this->assertSame(false, \spectrum\tests\automatic\Test::$temp["isExecuted"]);
	}
	
	public function testErrorHandling_BreakOnFirstPhpErrorIsEnabled_GetsValueFromAncestorsOrSelf() {
		\spectrum\tests\automatic\Test::$temp["callCount"] = -1;
		\spectrum\tests\automatic\Test::$temp["isExecuted"] = array();
		
		$this->registerPluginWithCodeInEvent('
			\spectrum\tests\automatic\Test::$temp["callCount"]++;
			
			\spectrum\tests\automatic\Test::$temp["isExecuted"][\spectrum\tests\automatic\Test::$temp["callCount"]][] = 1;
			trigger_error("aaa");
			\spectrum\tests\automatic\Test::$temp["isExecuted"][\spectrum\tests\automatic\Test::$temp["callCount"]][] = 2;
		', 'onEndingSpecExecute');
		...
		$this->assertSame(array(
			...
			array(1),
			array(1, 2),
		), \spectrum\tests\automatic\Test::$temp["isExecuted"]);
	}
