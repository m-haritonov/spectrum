...
class MessagesTest extends \spectrum\tests\automatic\Test {
	public function testRemovesAllMessagesBeforeEachRun() {
		\spectrum\tests\automatic\Test::$temp["messages"] = null;
		...
		$this->assertSame(array(), \spectrum\tests\automatic\Test::$temp["messages"]);
...
/**/
	...
	public function testAdd_CallOnRun_DoesNotThrowsExceptionAndAddsMessage() {
		...
		$this->assertSame(null, \spectrum\tests\automatic\Test::$temp["exception"]);
		$this->assertSame(array('aaa aaa'), $spec->messages->getAll());
	}
