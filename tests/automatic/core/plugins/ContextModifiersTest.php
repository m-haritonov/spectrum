...
class ContextModifiersTest extends \spectrum\tests\automatic\Test {
	...
	public function testAdd_CallOnRun_ThrowsExceptionAndDoesNotAddValue() {
		...
		$this->assertSame('Call of "\spectrum\core\plugins\ContextModifiers::add" method is forbidden on run', \spectrum\tests\automatic\Test::$temp["exception"]->getMessage());
	...
	public function testGetAllThroughRunningAncestors_TypeIsBefore_ReturnsRowsInOrderFromRootRunningAncestorToSelf() {
		...
		$this->registerPluginWithCodeInEvent('
			if ($this->getOwnerSpec() === \spectrum\tests\automatic\Test::$temp["specs"]["checkpoint"]) {
				\spectrum\tests\automatic\Test::$temp["returnValues"][] = $this->getOwnerSpec()->contextModifiers->getAllThroughRunningAncestors("before");
			}
		');
		...
		\spectrum\tests\automatic\Test::$temp["specs"][0]->contextModifiers->add($function1, 'before');
		\spectrum\tests\automatic\Test::$temp["specs"][0]->contextModifiers->add($function2, 'before');
		\spectrum\tests\automatic\Test::$temp["specs"][1]->contextModifiers->add($function3, 'before');
		\spectrum\tests\automatic\Test::$temp["specs"][1]->contextModifiers->add($function4, 'before');
		\spectrum\tests\automatic\Test::$temp["specs"][2]->contextModifiers->add($function5, 'before');
		\spectrum\tests\automatic\Test::$temp["specs"][2]->contextModifiers->add($function6, 'before');
		\spectrum\tests\automatic\Test::$temp["specs"]['checkpoint']->contextModifiers->add($function7, 'before');
		\spectrum\tests\automatic\Test::$temp["specs"]['checkpoint']->contextModifiers->add($function8, 'before');
		...
		), \spectrum\tests\automatic\Test::$temp["returnValues"]);
	}
...
/**/
	...
	public function testGetAllThroughRunningAncestors_TypeIsAfter_ReturnsRowsInOrderFromSelfToRootRunningAncestor() {
		...
		$this->registerPluginWithCodeInEvent('
			if ($this->getOwnerSpec() === \spectrum\tests\automatic\Test::$temp["specs"]["checkpoint"]) {
				\spectrum\tests\automatic\Test::$temp["returnValues"][] = $this->getOwnerSpec()->contextModifiers->getAllThroughRunningAncestors("after");
			}
		');
		...
		\spectrum\tests\automatic\Test::$temp["specs"][0]->contextModifiers->add($function1, 'after');
		\spectrum\tests\automatic\Test::$temp["specs"][0]->contextModifiers->add($function2, 'after');
		\spectrum\tests\automatic\Test::$temp["specs"][1]->contextModifiers->add($function3, 'after');
		\spectrum\tests\automatic\Test::$temp["specs"][1]->contextModifiers->add($function4, 'after');
		\spectrum\tests\automatic\Test::$temp["specs"][2]->contextModifiers->add($function5, 'after');
		\spectrum\tests\automatic\Test::$temp["specs"][2]->contextModifiers->add($function6, 'after');
		\spectrum\tests\automatic\Test::$temp["specs"]['checkpoint']->contextModifiers->add($function7, 'after');
		\spectrum\tests\automatic\Test::$temp["specs"]['checkpoint']->contextModifiers->add($function8, 'after');
...
/**/
	...
	public function testRemove_CallOnRun_ThrowsExceptionAndDoesNotRemoveValue() {
		...
		$this->assertInstanceOf('\spectrum\Exception', \spectrum\tests\automatic\Test::$temp["exception"]);
		$this->assertSame('Call of "\spectrum\core\plugins\ContextModifiers::remove" method is forbidden on run', \spectrum\tests\automatic\Test::$temp["exception"]->getMessage());
		$this->assertSame(array(
			array('function' => $function1, 'type' => 'before'), 
		), $spec->contextModifiers->getAll());
	}
...
/**/
	...
	public function testRemoveAll_CallOnRun_ThrowsExceptionAndDoesNotRemoveValues() {
		...
		$this->assertInstanceOf('\spectrum\Exception', \spectrum\tests\automatic\Test::$temp["exception"]);
		$this->assertSame('Call of "\spectrum\core\plugins\ContextModifiers::removeAll" method is forbidden on run', \spectrum\tests\automatic\Test::$temp["exception"]->getMessage());
		$this->assertSame(array(
			array('function' => $function1, 'type' => 'before'), 
		), $spec->contextModifiers->getAll());
	}
