...
class TestTest extends \spectrum\tests\automatic\Test {
	...
	public function testSetFunction_CallOnRun_ThrowsExceptionAndDoesNotChangeFunction() {
		...
		$this->assertSame('Call of "\spectrum\core\plugins\Test::setFunction" method is forbidden on run', \spectrum\tests\automatic\Test::$temp["exception"]->getMessage());
...
/**/
	...
	public function testGetFunctionThroughRunningAncestors_ReturnsFunctionFromRunningAncestorOrFromSelf() {
		...
		$this->registerPluginWithCodeInEvent('
			\spectrum\tests\automatic\Test::$temp["returnValues"][] = $this->getOwnerSpec()->test->getFunctionThroughRunningAncestors();
		', 'onEndingSpecExecute');
...
/**/
	...
	public function testFunctionCall_FunctionNotSet_DoesNotInitializeData() {
		\spectrum\tests\automatic\Test::$temp["dataInitializeCount"] = 0;
		config::setClassReplacement('\spectrum\core\Data', $this->createClass('
			class ... extends \spectrum\core\Data {
				public function __construct() {
					\spectrum\tests\automatic\Test::$temp["dataInitializeCount"]++;
				}
			}
		'));
		...
		$spec = new Spec();
		$spec->run();
		$this->assertSame(0, \spectrum\tests\automatic\Test::$temp["dataInitializeCount"]);
	}
