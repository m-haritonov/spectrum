...
class ContextModifiersTest extends \spectrum\tests\automatic\Test {
	...
	public function testAdd_CallOnRun_ThrowsExceptionAndDoesNotAddValue() {
		...
		$this->assertSame('Call of "\spectrum\core\models\ContextModifiers::add" method is forbidden on run', $exception->getMessage());
		$this->assertSame(array(), $spec->getContextModifiers()->getAll());
	}
	
	public function testAdd_ThrowsExceptionForInvalidTypes() {
		$spec = new Spec();
		$this->assertThrowsException('\spectrum\core\Exception', 'Unknown type "aaa" is passed to "\spectrum\core\models\ContextModifiers::add" method', function() use($spec) {
...
/**/
	...
	public function testGetAll_ThrowsExceptionForInvalidTypes() {
		$spec = new Spec();
		$this->assertThrowsException('\spectrum\core\Exception', 'Unknown type "aaa" is passed to "\spectrum\core\models\ContextModifiers::getAll" method', function() use($spec) {
...
/**/
	...
	public function testGetAllThroughRunningAncestors_ThrowsExceptionForInvalidTypes() {
		$spec = new Spec();
		$this->assertThrowsException('\spectrum\core\Exception', 'Unknown type "aaa" is passed to "\spectrum\core\models\ContextModifiers::getAllThroughRunningAncestors" method', function() use($spec) {
...
/**/
	...
	public function testRemove_CallOnRun_ThrowsExceptionAndDoesNotRemoveValue() {
		...
		$this->assertInstanceOf('\spectrum\core\Exception', $exception);
		$this->assertSame('Call of "\spectrum\core\models\ContextModifiers::remove" method is forbidden on run', $exception->getMessage());
		$this->assertSame(array(
			array('function' => $function1, 'type' => 'before'), 
		), $spec->getContextModifiers()->getAll());
	}
...
/**/
	...
	public function testRemoveAll_CallOnRun_ThrowsExceptionAndDoesNotRemoveValues() {
		...
		$this->assertInstanceOf('\spectrum\core\Exception', $exception);
		$this->assertSame('Call of "\spectrum\core\models\ContextModifiers::removeAll" method is forbidden on run', $exception->getMessage());
		$this->assertSame(array(
			array('function' => $function1, 'type' => 'before'), 
		), $spec->getContextModifiers()->getAll());
	}
