...
/**/
	...
	public function testSetParentSpec_ShouldBeThrowExceptionIfNotAllowSpecsModifyWhenRunning()
	{
		...
		$spec->errorHandling->setCatchExceptions(false);
		$spec->setTestCallback(function() use($spec){
			$spec->setParentSpec(new SpecContainerDescribe());
		});
...
/**/
	...
	public function testRemoveFromParentSpec_ShouldBeThrowExceptionIfNotAllowSpecsModifyWhenRunning()
	{
		config::setAllowSpecsModifyWhenRunning(false);
