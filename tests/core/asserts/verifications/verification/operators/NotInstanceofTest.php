...
class NotInstanceofTest extends \spectrum\core\verifications\verification\Test
{
	public function testShouldBeReturnTrueIfValue1ObjectNotInstanceOfValue2Object()
	{
	...
	public function testShouldBeReturnTrueIfValue1ObjectNotInstanceOfValue2Class()
	{
		$this->runInTestCallback($this->createSpecIt(), function($test, $it) use(&$verify)
		{
			$object1 = new \stdClass();
	...
	public function testShouldBeReturnFalseIfValue1ObjectInstanceOfValue2Object()
	{
		$this->runInTestCallback($this->createSpecIt(), function($test, $it) use(&$verify)
		{
			$object1 = new \stdClass();
	...
	public function testShouldBeReturnFalseIfValue1ObjectInstanceOfValue2Class()
	{
		$this->runInTestCallback($this->createSpecIt(), function($test, $it) use(&$verify)
		{
			$object1 = new \stdClass();
