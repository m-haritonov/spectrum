...
class ContextsTest extends \spectrum\tests\Test
{
	...
	public function testAdd_CallOnRun_ThrowsExceptionAndDoesNotAddValue()
	{
		...
		$this->assertSame('Call of "\spectrum\core\plugins\contexts\Contexts::add" method is forbidden on run', \spectrum\tests\Test::$temp["exception"]->getMessage());
...
/**/
	...
	public function testRemove_CallOnRun_ThrowsExceptionAndDoesNotRemoveValue()
	{
		...
		$this->assertInstanceOf('\spectrum\core\plugins\Exception', \spectrum\tests\Test::$temp["exception"]);
		$this->assertSame('Call of "\spectrum\core\plugins\contexts\Contexts::remove" method is forbidden on run', \spectrum\tests\Test::$temp["exception"]->getMessage());
		$this->assertSame(array(
			array('function' => $function1, 'type' => 'before'), 
		), $spec->contexts->getAll());
	}
...
/**/
	...
	public function testRemoveAll_CallOnRun_ThrowsExceptionAndDoesNotRemoveValues()
	{
		...
		$this->assertInstanceOf('\spectrum\core\plugins\Exception', \spectrum\tests\Test::$temp["exception"]);
		$this->assertSame('Call of "\spectrum\core\plugins\contexts\Contexts::removeAll" method is forbidden on run', \spectrum\tests\Test::$temp["exception"]->getMessage());
		$this->assertSame(array(
			array('function' => $function1, 'type' => 'before'), 
		), $spec->contexts->getAll());
	}
...
/**/
	...
	public function testCallFunctionInContext_PhpIsGreaterThanOrEqualTo54_BindContextDataToThisVariable()
	{
		...
		$this->assertInstanceOf('\spectrum\core\plugins\contexts\Data', \spectrum\tests\Test::$temp["this"]);
...
/**/
	...
	public function testGetContextData_ContextDataIsInitialized_ReturnsInstanceOfContextData()
	{
		...
		$this->assertInstanceOf('\spectrum\core\plugins\contexts\Data', \spectrum\tests\Test::$temp["contextData"]);
	}
	...
	public function testGetContextData_ContextDataIsInitialized_ReturnsNewInstanceOnEveryRun()
	{
		...
		$this->assertInstanceOf('\spectrum\core\plugins\contexts\Data', \spectrum\tests\Test::$temp["contextData"][0]);
		$this->assertInstanceOf('\spectrum\core\plugins\contexts\Data', \spectrum\tests\Test::$temp["contextData"][1]);
		$this->assertInstanceOf('\spectrum\core\plugins\contexts\Data', \spectrum\tests\Test::$temp["contextData"][2]);
