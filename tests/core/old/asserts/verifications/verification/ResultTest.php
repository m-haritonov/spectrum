...
class ResultTest extends Test
{
	...
	public function testResultIsTrue_BreakOnFirstMatcherFailDisabled_ShouldBeAddTrueWithCallDetailsToResultBufferForEachVerification()
	{
		$it = $this->createSpecIt();
		$it->errorHandling->setBreakOnFirstMatcherFail(false);
		$this->runInTestCallback($it, function($test, $it) use(&$resultBuffer)
		{
...
/**/
	...
	public function testResultIsTrue_BreakOnFirstMatcherFailEnabled_ShouldBeAddTrueWithCallDetailsToResultBufferForEachVerification()
	{
		$it = $this->createSpecIt();
		$it->errorHandling->setBreakOnFirstMatcherFail(true);
		$this->runInTestCallback($it, function($test, $it) use(&$resultBuffer)
...
/**/
	...
	public function testResultIsFalse_BreakOnFirstMatcherFailDisabled_ShouldBeAddFalseWithCallDetailsToResultBufferForEachVerification()
	{
		$it = $this->createSpecIt();
		$it->errorHandling->setBreakOnFirstMatcherFail(false);
		$this->runInTestCallback($it, function($test, $it) use(&$resultBuffer)
...
/**/
	...
	public function testResultIsFalse_BreakOnFirstMatcherFailEnabled_ShouldBeAddFalseWithCallDetailsToResultBuffer()
	{
		$it = $this->createSpecIt();
		$it->errorHandling->setBreakOnFirstMatcherFail(true);
		$this->runInTestCallback($it, function($test, $it) use(&$resultBuffer)
...
/**/
	...
	public function testThrowsException_BreakOnFirstMatcherFailDisabled_CatchExceptionsDisabled_ShouldNotBeAddResultToResultBuffer()
	{
		try
		{
			$it = $this->createSpecIt();
		...
		$this->assertEquals(0, count($resultBuffer->getResults()));
	}
...
/**/
	...
	public function testThrowsException_BreakOnFirstMatcherFailDisabled_CatchExceptionsEnabled_ShouldBeAddFalseWithExceptionAsDetailsToResultBuffer()
	{
		$it = $this->createSpecIt();
		$it->errorHandling->setBreakOnFirstMatcherFail(false);
		$it->errorHandling->setCatchExceptions(true);
...
/**/
	...
	public function testThrowsException_BreakOnFirstMatcherFailEnabled_CatchExceptionsDisabled_ShouldNotBeAddResultToResultBuffer()
	{
		try
		{
			$it = $this->createSpecIt();
...
/**/
	...
	public function testThrowsException_BreakOnFirstMatcherFailEnabled_CatchExceptionsEnabled_ShouldBeAddFalseWithExceptionAsDetailsToResultBuffer()
	{
		$it = $this->createSpecIt();
		$it->errorHandling->setBreakOnFirstMatcherFail(true);
		$it->errorHandling->setCatchExceptions(true);
